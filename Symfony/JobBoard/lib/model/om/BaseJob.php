...
abstract class BaseJob extends BaseObject  implements Persistent {
	...
	/**
	 * The value for the agree_terms field.
	 * Note: this column has a database default value of: false
	 * @var        boolean
	 */
	protected $agree_terms;
	...
	/**
	 * @var        array JobIndex[] Collection to store aggregation of JobIndex objects.
	 */
	protected $collJobIndexs;

	/**
	 * @var        Criteria The criteria used to select the current contents of collJobIndexs.
	 */
	private $lastJobIndexCriteria = null;
	...
	/**
	 * Get the [agree_terms] column value.
	 * 
	 * @return     boolean
	 */
	...
	public function setLocation($v)
	{
		...
		if ($this->location !== $v) {
			$this->location = $v;
			$this->modifiedColumns[] = JobPeer::LOCATION;
		}
	...
	public function setCompany($v)
	{
		...
		if ($this->company !== $v) {
			$this->company = $v;
			$this->modifiedColumns[] = JobPeer::COMPANY;
		}
	...
	public function setEmail($v)
	{
		...
		if ($this->email !== $v) {
			$this->email = $v;
			$this->modifiedColumns[] = JobPeer::EMAIL;
		}
	...
	public function setCategoryId($v)
	{
		...
		if ($this->category_id !== $v) {
			$this->category_id = $v;
			$this->modifiedColumns[] = JobPeer::CATEGORY_ID;
		}
	...
	public function setKeywords($v)
	{
		...
		if ($this->keywords !== $v) {
			$this->keywords = $v;
			$this->modifiedColumns[] = JobPeer::KEYWORDS;
		}
	...
	public function setPosition($v)
	{
		...
		if ($this->position !== $v) {
			$this->position = $v;
			$this->modifiedColumns[] = JobPeer::POSITION;
		}
	...
	public function setDescription($v)
	{
		...
		if ($this->description !== $v) {
			$this->description = $v;
			$this->modifiedColumns[] = JobPeer::DESCRIPTION;
		}
	...
	public function setToken($v)
	{
		...
		if ($this->token !== $v) {
			$this->token = $v;
			$this->modifiedColumns[] = JobPeer::TOKEN;
		}
	...
	public function setIsActivated($v)
	{
		...
		if ($this->is_activated !== $v || $this->isNew()) {
			$this->is_activated = $v;
			$this->modifiedColumns[] = JobPeer::IS_ACTIVATED;
		}
	...
	/**
	 * Set the value of [agree_terms] column.
	 * 
	 * @param      boolean $v new value
	 * @return     Job The current object (for fluent API support)
	 */
	public function setAgreeTerms($v)
	{
		if ($v !== null) {
			$v = (boolean) $v;
		}

		if ($this->agree_terms !== $v || $this->isNew()) {
			$this->agree_terms = $v;
			$this->modifiedColumns[] = JobPeer::AGREE_TERMS;
		}
	...
	public function setExpiresAt($v)
	{
		...
		if ( $this->expires_at !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = JobPeer::EXPIRES_AT;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->position = ($row[$startcol + 8] !== null) ? (string) $row[$startcol + 8] : null;
			...
			$this->is_activated = ($row[$startcol + 11] !== null) ? (boolean) $row[$startcol + 11] : null;
			$this->agree_terms = ($row[$startcol + 12] !== null) ? (boolean) $row[$startcol + 12] : null;
			$this->expires_at = ($row[$startcol + 13] !== null) ? (string) $row[$startcol + 13] : null;
			...
			return $startcol + 16; // 16 = JobPeer::NUM_COLUMNS - JobPeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		if ($deep) {  // also de-associate any related objects?
			...
			$this->aCategory = null;
			$this->collJobIndexs = null;
			$this->lastJobIndexCriteria = null;
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->collJobIndexs !== null) {
				foreach ($this->collJobIndexs as $referrerFK) {
	...
	public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true)
	{
		...
		$result = array(
			...
			$keys[11] => $this->getIsActivated(),
			$keys[12] => $this->getAgreeTerms(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[11], $arr)) $this->setIsActivated($arr[$keys[11]]);
		if (array_key_exists($keys[12], $arr)) $this->setAgreeTerms($arr[$keys[12]]);
		if (array_key_exists($keys[13], $arr)) $this->setExpiresAt($arr[$keys[13]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(JobPeer::LOCATION)) $criteria->add(JobPeer::LOCATION, $this->location);
		if ($this->isColumnModified(JobPeer::COMPANY)) $criteria->add(JobPeer::COMPANY, $this->company);
		if ($this->isColumnModified(JobPeer::EMAIL)) $criteria->add(JobPeer::EMAIL, $this->email);
		if ($this->isColumnModified(JobPeer::CATEGORY_ID)) $criteria->add(JobPeer::CATEGORY_ID, $this->category_id);
		if ($this->isColumnModified(JobPeer::TITLE)) $criteria->add(JobPeer::TITLE, $this->title);
		if ($this->isColumnModified(JobPeer::KEYWORDS)) $criteria->add(JobPeer::KEYWORDS, $this->keywords);
		if ($this->isColumnModified(JobPeer::POSITION)) $criteria->add(JobPeer::POSITION, $this->position);
		if ($this->isColumnModified(JobPeer::DESCRIPTION)) $criteria->add(JobPeer::DESCRIPTION, $this->description);
		if ($this->isColumnModified(JobPeer::TOKEN)) $criteria->add(JobPeer::TOKEN, $this->token);
		if ($this->isColumnModified(JobPeer::IS_ACTIVATED)) $criteria->add(JobPeer::IS_ACTIVATED, $this->is_activated);
		if ($this->isColumnModified(JobPeer::AGREE_TERMS)) $criteria->add(JobPeer::AGREE_TERMS, $this->agree_terms);
		if ($this->isColumnModified(JobPeer::EXPIRES_AT)) $criteria->add(JobPeer::EXPIRES_AT, $this->expires_at);
	...
	public function copyInto($copyObj, $deepCopy = false)
	{
		...
		$copyObj->setAgreeTerms($this->agree_terms);
		...
		if ($deepCopy) {
			...
			foreach ($this->getJobIndexs() as $relObj) {
				if ($relObj !== $this) {  // ensure that we don't try to copy a reference to ourselves
					$copyObj->addJobIndex($relObj->copy($deepCopy));
				}
			}
	...
	/**
	 * Clears out the collJobIndexs collection (array).
	 *
	 ...
	 * @see        addJobIndexs()
	 */
	public function clearJobIndexs()
	{
		$this->collJobIndexs = null; // important to set this to NULL since that means it is uninitialized
	}

	/**
	 * Initializes the collJobIndexs collection (array).
	 *
	 * By default this just sets the collJobIndexs collection to an empty array (like clearcollJobIndexs());
	 * however, you may wish to override this method in your stub class to provide setting appropriate
	 * to your application -- for example, setting the initial array to the values stored in database.
	 *
	 * @return     void
	 */
	public function initJobIndexs()
	{
		$this->collJobIndexs = array();
	}

	/**
	 * Gets an array of JobIndex objects which contain a foreign key that references this object.
	 *
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Job has previously been saved, it will retrieve
	 * related JobIndexs from storage. If this Job is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
	 * @return     array JobIndex[]
	 * @throws     PropelException
	 */
	public function getJobIndexs($criteria = null, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
		}
		...
		if ($this->collJobIndexs === null) {
			if ($this->isNew()) {
			   $this->collJobIndexs = array();
				...
				$criteria->add(JobIndexPeer::JOB_ID, $this->id);

				JobIndexPeer::addSelectColumns($criteria);
				$this->collJobIndexs = JobIndexPeer::doSelect($criteria, $con);
			}
		} else {
			...
			if (!$this->isNew()) {
				...
				JobIndexPeer::addSelectColumns($criteria);
				if (!isset($this->lastJobIndexCriteria) || !$this->lastJobIndexCriteria->equals($criteria)) {
					$this->collJobIndexs = JobIndexPeer::doSelect($criteria, $con);
				}
			}
		}
		$this->lastJobIndexCriteria = $criteria;
		return $this->collJobIndexs;
	}

	/**
	 * Returns the number of related JobIndex objects.
	 *
	 * @param      Criteria $criteria
	 * @param      boolean $distinct
	 * @param      PropelPDO $con
	 * @return     int Count of related JobIndex objects.
	 * @throws     PropelException
	 */
	public function countJobIndexs(Criteria $criteria = null, $distinct = false, PropelPDO $con = null)
	{
		if ($criteria === null) {
			$criteria = new Criteria(JobPeer::DATABASE_NAME);
		} else {
		...
		if ($this->collJobIndexs === null) {
			if ($this->isNew()) {
				...
				$count = JobIndexPeer::doCount($criteria, false, $con);
			}
		} else {
			// criteria has no effect for a new object
			if (!$this->isNew()) {
				...
				if (!isset($this->lastJobIndexCriteria) || !$this->lastJobIndexCriteria->equals($criteria)) {
					...
					$count = count($this->collJobIndexs);
				}
			} else {
				$count = count($this->collJobIndexs);
			}
	...
	/**
	 * Method called to associate a JobIndex object to this object
	 * through the JobIndex foreign key attribute.
	 *
	 * @param      JobIndex $l JobIndex
	 * @return     void
	 * @throws     PropelException
	 */
	public function addJobIndex(JobIndex $l)
	{
		if ($this->collJobIndexs === null) {
			$this->initJobIndexs();
		}
		if (!in_array($l, $this->collJobIndexs, true)) { // only add it if the **same** object is not already associated
			array_push($this->collJobIndexs, $l);
			$l->setJob($this);
		}
	}
	...
	{
		if ($deep) {
			if ($this->collJobIndexs) {
				foreach ((array) $this->collJobIndexs as $o) {
